...
<div id="<?php echo esc_html($prefix); ?>qr-container<?php echo esc_html($sufix); ?>" class="qr-container" data-public-donors="<?php echo esc_attr($public_donors); ?>">
    ...
    <div id="<?php echo esc_html($prefix); ?>public-donor-popup<?php echo esc_html($sufix); ?>" class="public-donor-popup">
        ...
        <form class="public-donor-form">
            ...
            <?php if (isset($shoutout) && $shoutout == 1): ?>
                <label for="<?php echo esc_html($prefix); ?>public-name<?php echo esc_html($sufix); ?>">Public Name</label>
                <input
                    type="text"
                    id="<?php echo esc_html($prefix); ?>public-name<?php echo esc_html($sufix); ?>"
                    placeholder="Optional">

                <label for="<?php echo esc_html($prefix); ?>public-message<?php echo esc_html($sufix); ?>">Public Message</label>
                <textarea
                    id="<?php echo esc_html($prefix); ?>public-message<?php echo esc_html($sufix); ?>"
                    placeholder="Optional"
                    rows="3"></textarea>
            <?php endif; ?>
    ...
    <div id="<?php echo esc_html($prefix); ?>payment-popup<?php echo esc_html($sufix); ?>" class="payment-popup">
        ...
        <button id="<?php echo esc_html($prefix); ?>pay-in-wallet<?php echo esc_html($sufix); ?>" class="qr-pay-in-wallet"><?php echo esc_html_e('Pay in wallet', 'coinsnap-bitcoin-crowdfunding');?></button>
    </div>
